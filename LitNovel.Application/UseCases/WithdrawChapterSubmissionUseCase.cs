...
{
    public class WithdrawChapterSubmissionUseCase : IWithdrawChapterSubmissionUseCase
    {
        private readonly IChapterRepository _chapterRepository;
        private readonly ICurrentUserService _currentUserService;
        private readonly IUnitOfWork _unitOfWork;

        public WithdrawChapterSubmissionUseCase(
        ...
        public async Task<SubmitChapterResponseDto> ExecuteAsync(int id, CancellationToken ct)
        {
            ...
            {
                throw new BadRequestException("Chapter must be in Pending status to withdraw");
            }

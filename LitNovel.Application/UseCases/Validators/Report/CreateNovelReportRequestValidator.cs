...
{
    public class CreateNovelReportRequestValidator : AbstractValidator<CreateNovelReportRequestDto>
    {
        public CreateNovelReportRequestValidator()
        {
            RuleFor(x => x.TargetNovelId).GreaterThan(0);
